...
mapping = {
    "p2d_reverse_prompts_test": "data/reverse_experiments/experiment1/p2d_reverse_prompts_test.jsonl",
    "both_prompts_test": "data/reverse_experiments/experiment1/both_prompts_test.jsonl",
    "p2d_prompts_test": "data/reverse_experiments/experiment1/p2d_prompts_test.jsonl",
    "d2p_prompts_test": "data/reverse_experiments/experiment1/d2p_prompts_test.jsonl",
    "d2p_reverse_prompts_test": "data/reverse_experiments/experiment1/d2p_reverse_prompts_test.jsonl",
    "p2d_reverse_prompts_test_randomized": "data/reverse_experiments/experiment1/p2d_reverse_prompts_test_randomized.jsonl",
    "d2p_reverse_prompts_test_randomized": "data/reverse_experiments/experiment1/d2p_reverse_prompts_test_randomized.jsonl",
}
...
class ReverseEvaluator(BaseEvaluator):
    ...
    def _run(self, models: List[Tuple[Model, str]], metrics: Dict = {}, tables: Dict = {}):
        ...
        for column in tqdm(KEYS_WE_CARE_ABOUT):
            df, metrics_dt = self.evaluate_model_on_file(mapping[column], column)
            tables[column] = df
